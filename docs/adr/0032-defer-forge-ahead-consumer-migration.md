...
Remote Authentication shape to `@forge-ahead/remote` in `specs/MIGRATION.md`, rather
...
extraction can safely edit. `specs/MIGRATION.md` gives `forge-ahead` maintainers a
